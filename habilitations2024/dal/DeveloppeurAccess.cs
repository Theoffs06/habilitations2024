...
namespace habilitations2024.dal {
    ...
    public class DeveloppeurAccess {
        ...
        public bool ControleAuthentification(Admin admin) {
            ...
            var parameters = new Dictionary<string, object> {{ "@nom", admin.Nom }, { "@prenom", admin.Prenom }, { "@pwd", admin.Pwd }};
            try {
        ...
        public void AddDeveloppeur(Developpeur developpeur) {
            ...
            var parameters = new Dictionary<string, object> { 
                { "@nom", developpeur.Nom }, { "@prenom", developpeur.Prenom }, { "@tel", developpeur.Tel },
                { "@mail", developpeur.Mail }, { "@pwd", developpeur.Nom }, { "@idprofil", developpeur.Profil.Idprofil }
            };
            try {
                _access.Manager.ReqUpdate(req, parameters);
            }
        ...
        public void UpdateDeveloppeur(Developpeur developpeur) {
            ...
            var parameters = new Dictionary<string, object> {
                { "@idDeveloppeur", developpeur.Iddeveloppeur }, { "@nom", developpeur.Nom }, { "@prenom", developpeur.Prenom },
                { "@tel", developpeur.Tel }, { "@mail", developpeur.Mail }, { "@idprofil", developpeur.Profil.Idprofil }
            };
            try {
                _access.Manager.ReqUpdate(req, parameters);
            }
        ...
        public void UpdatePwd(Developpeur developpeur) {
            ...
            req += "where iddeveloppeur = @iddeveloppeur;";
            var parameters = new Dictionary<string, object> {{ "@idDeveloppeur", developpeur.Iddeveloppeur }, { "@pwd", developpeur.Pwd }};
            try {
                _access.Manager.ReqUpdate(req, parameters);
            }
            catch (Exception e) {
